...
const fifteenInventors = inventors.filter(inventor =>
...
let newInventors = inventors.map(inventor => (`${inventor.first}  ${inventor.last}`));
...
const totatlYears = inventors.reduce((total, inventor) => {
    return total + (inventor.passed - inventor.year);
}, 0);
console.log(totatlYears);
...
const sortAlpha = people.sort(function (lastOne, nextOne) {
